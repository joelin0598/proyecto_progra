...
update usuario
set nombres='Joel', apellidos='Morales'
where id=1;
...
alter table solicitud_muestra_medica  drop column cantidad_muestra;
...
alter table usuario add column id_tipo_usuario integer default 1;
